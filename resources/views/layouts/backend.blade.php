...
<head>
    ...
    <title>Root Capital</title>

    <meta name="description" content="Ejercicio práctico DBI Specialist Flobal">
    ...
    <link rel="shortcut icon" href="https://rootcapital.org/wp-content/uploads/2024/07/Master-Logo-2-Copy-150x150.png">
    <link rel="icon" sizes="192x192"
        type="https://rootcapital.org/wp-content/uploads/2024/07/Master-Logo-2-Copy.png">
    <link rel="apple-touch-icon" sizes="180x180"
        href="https://rootcapital.org/wp-content/uploads/2024/07/Master-Logo-2-Copy.png">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="fw-semibold text-white tracking-wide" href="/">
                        ...
                        <span class="smini-hidden">
                            Root<span class="opacity-75">Capital</span>
                        </span>
                    </a>
                    <!-- END Logo -->
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-heading">Consultas</li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('candidatos.index') }}">
                                <i class="nav-main-link-icon fa fa-lightbulb"></i>
                                <span class="nav-main-link-name">Candidatos</span>
                                <span
                                    @if ($total_candidatos) class="nav-main-link-badge badge rounded-pill bg-warning">{{ $total_candidatos }} @endif
                                    </span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="content py-0">
                <div class="row fs-sm">
                    <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
                        <i class=" text-danger"></i> <a class="fw-semibold" href="https://rootcapital.org/"
                            target="_blank">Root Capital</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="https://rootcapital.org/" target="_blank">Root
                            Capital</a> &copy;
